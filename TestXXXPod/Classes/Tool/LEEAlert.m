...
- (void)keyboardWillChangeFrame:(NSNotification *)notify{
    ...
    if (self.config.modelIsAvoidKeyboard) {
        ...
        isShowingKeyboard = keyboardFrame.origin.y < KWIDTH;
    ...
    switch (type) {
        ...
        case LEEAlertTypeAlert:
            ...
            .LeeConfigMaxHeight(^CGFloat(LEEScreenOrientationType type) {
                ...
                return KHEIGHT - 40.0f - VIEWSAFEAREAINSETS([LEEAlert getAlertWindow]).top - VIEWSAFEAREAINSETS([LEEAlert getAlertWindow]).bottom;
            })
        ...
        case LEEAlertTypeActionSheet:
            ...
            .LeeConfigMaxWidth(^CGFloat(LEEScreenOrientationType type) {
                ...
                return type == LEEScreenOrientationTypeHorizontal ? KHEIGHT - VIEWSAFEAREAINSETS([LEEAlert getAlertWindow]).top - VIEWSAFEAREAINSETS([LEEAlert getAlertWindow]).bottom - 20.0f : KWIDTH - VIEWSAFEAREAINSETS([LEEAlert getAlertWindow]).left - VIEWSAFEAREAINSETS([LEEAlert getAlertWindow]).right - 20.0f;
            })
            .LeeConfigMaxHeight(^CGFloat(LEEScreenOrientationType type) {
